...
@property (assign,nonatomic)NSInteger skim;
@property (assign,nonatomic)NSInteger believable;
@property (assign,nonatomic)NSInteger doubt;
...
//增加对象
-(void)addWithtitle:(NSString *)title author:(NSString *)author date:(NSDate *)date skim:(NSInteger )skim believable:(NSInteger )believable doubt:(NSInteger )doubt describe:(NSString *)describe content:(NSString *)content ;//添加对象
...
-(void)changeObject:(News*)obj;//更改对象中的数据后保存
